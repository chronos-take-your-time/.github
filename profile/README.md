...
# Código-fonte
A aplicação é construída sobre estes dois repositórios, você pode subir os ambientes de desenvolvimento de modo manual, com Docker ou com Nix.

- [App Desktop do Chronos](https://github.com/chronos-take-your-time/app/)
- [Servidor do Chronos (API)](https://github.com/chronos-take-your-time/server/)
